<template>
  <div class="flex h-screen">
    ...
    <!-- Enhanced Login Form -->
    <LoginForm v-else-if="!isAuthenticated" :is-submitting="isSubmitting" :login-error="loginError"
      :login-success="loginSuccess" @login="handleLogin" @forgot-password="handleForgotPassword" />
