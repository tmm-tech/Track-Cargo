      ...
      <div class="container mx-auto">
        <div class="flex flex-col md:flex-row justify-between">
          ...
          <div class="hidden md:flex items-center space-x-2">
            <router-link
              to="/track"
              class="px-6 py-3 bg-transparent text-white border border-white rounded-md hover:bg-red-600 hover:border-red-600 hover:text-white transition-colors duration-300 inline-block"
            >
              Track Cargo
            </router-link>
            <router-link
              to="/admin"
              class="px-6 py-3 bg-[#ffb600] text-[#273272] rounded-md hover:bg-[#e6a500] transition-colors duration-300 inline-block"
            >
              Admin
            </router-link>
          </div>
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto">
          <Card class="border-none shadow-lg">
            ...
            <CardContent class="pt-6">
              <form @submit.prevent="handleSubmit" class="space-y-6">
                <div class="space-y-2">
                  <Label for="tracking-number">Tracking or Dispatch Number</Label>
                  <div class="relative">
                    <Input
                      id="tracking-number"
                ...
                <Button 
                  type="submit" 
                  class="w-full bg-[#ffb600] hover:bg-[#e6a500] text-[#273272] font-bold"
                  :disabled="isSubmitting"
                >
                  <Loader v-if="isSubmitting" class="animate-spin mr-2 h-4 w-4" />
          ...
          <div class="mt-8 text-center">
            <p class="text-gray-600">Need help with tracking?</p>
            <p class="mt-2">
              <a href="tel:+254795616827" class="text-[#273272] font-medium hover:underline">
                Call us at (+254) 795 616 827
              </a>
            </p>
          </div>
        </div>
